  <div data-window='createServerError_window' class='window window_bg'>

    <div data-part='handle' class='window_title window_border'>
      <div data-part='title' class='title_bg window_border'>ERROR CREATING SERVER</div>
    </div>
    ...
    <div class='window_body'>
      <div class='p-3 text-center text-white' style='font-size: 13px;'>
        ...
        You left your server IP Address blank.
